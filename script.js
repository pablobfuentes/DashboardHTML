...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderTable(tableElement, headers, rows, isMainTemplate = false) {
        ...
        // Apply selection styles if any row/column is selected
    ...
    function handleContextMenuItemClick(event) {
        ...
        updateAllProjectTables(); // Propagate changes to project tabs
        clearSelectionAndHideMenu(); // Clear selection and hide menu after action
    }
    ...
    addProjectButton.addEventListener('click', () => {
        ...
        const initialProjectName = `Project ${projectCount}`; // Use a clearer variable name

        // Create new tab button
        const newTabButton = document.createElement('button');
        newTabButton.classList.add('tab-button');
        newTabButton.dataset.tab = projectId;
        newTabButton.textContent = initialProjectName; // Set initial text
...
>>>>>>> 1ae5093ff997b05683e8b2e81c65ecb9eaf5ff55
});